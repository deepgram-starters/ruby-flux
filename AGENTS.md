...
Ruby (Sinatra) demo app for Deepgram Flux.
...
```
feat(ruby-flux): add diarization support
fix(ruby-flux): resolve WebSocket close handling
refactor(ruby-flux): simplify session endpoint
